...
Get the configuration object 'OKConfiguration'.
...
None
#>
function Set-OKConfigurationApiKey {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-OKConfigurationApiKeyPrefix {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-OKConfigurationDefaultHeader {
    [CmdletBinding()]
    Param(
        [string]$Key,
        [AllowEmptyString()]
...
String
#>
function Get-OKUrlFromHostSetting {
...
System.Collections.Hashtable
#>
function Set-OKConfigurationHttpSigning {
    [CmdletBinding()]
    param(
    ...
    Process {
        ...
        $keyType = Get-OKKeyTypeFromFile -KeyFilePath $KeyFilePath
...
Get the configuration object 'OKConfigurationHttpSigning'.
...
[PSCustomObject]
#>
function Get-OKConfigurationHttpSigning{
