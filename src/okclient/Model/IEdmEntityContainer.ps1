...
function Initialize-OKIEdmEntityContainer {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: okclient => OKIEdmEntityContainer' | Write-Debug
...
IEdmEntityContainer<PSCustomObject>
#>
function ConvertFrom-OKJsonToIEdmEntityContainer {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: okclient => OKIEdmEntityContainer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OKIEdmEntityContainer
        $AllProperties = ("elements", "schemaElementKind", "namespace", "name")
